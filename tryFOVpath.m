...
parfor i = 1:size(idList3, 1)
    temp = getFocusPath(fname, var3, idList3(i), 'GLLV');
    fov3{i, 2} = temp;
end
...
parfor i = 1:size(idList5, 1)
    temp = getFocusPath(fname, var5, idList5(i), 'GLLV');
    fov5{i, 2} = temp;
end
...
parfor i = 1:size(idList7, 1)
    temp = getFocusPath(fname, var7, idList7(i), 'GLLV');
    fov7{i, 2} = temp;
end
...
parfor i = 1:size(idList8, 1)
    temp = getFocusPath(fname, var8, idList8(i), 'GLLV');
    fov8{i, 2} = temp;
end
...
parfor i = 1:size(idListp22, 1)
    temp = getFocusPath(fname, varp22, idListp22(i), 'GLLV');
    fovp22{i, 2} = temp;
end
...
parfor i = 1:size(idListp24, 1)
    temp = getFocusPath(fname, varp24, idListp24(i), 'GLLV');
    fovp24{i, 2} = temp;
end
